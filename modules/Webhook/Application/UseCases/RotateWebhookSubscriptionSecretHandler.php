...
final readonly class RotateWebhookSubscriptionSecretHandler
{
    ...
    public function handle(RotateWebhookSubscriptionSecretCommand $command): WebhookSubscriptionResponse
    {
        ...
        $this->auditLogger->log(
            new AuditEntry(
                action: 'webhook.subscription_secret_rotated',
        ...
        return WebhookSubscriptionResponse::fromSubscription($subscription, $newSecret->value());
    }
}
