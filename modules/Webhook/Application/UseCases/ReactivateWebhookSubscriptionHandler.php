...
final readonly class ReactivateWebhookSubscriptionHandler
{
    ...
    public function handle(ReactivateWebhookSubscriptionCommand $command): WebhookSubscriptionResponse
    {
        ...
        $this->auditLogger->log(
            new AuditEntry(
                action: 'webhook.subscription_reactivated',
