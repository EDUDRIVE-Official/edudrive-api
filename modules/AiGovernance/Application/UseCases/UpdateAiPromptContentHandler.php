...
final readonly class UpdateAiPromptContentHandler
{
    public function __construct(private AiPromptRepository $prompts) {}

    public function handle(UpdateAiPromptContentCommand $command): AiPromptResponse
    {
        ...
        $prompt->updateContent($command->content);
