...
final readonly class VideoContentBlock implements ContentBlock
{
    private function __construct(
        private ContentBlockId $id,
        private int $position,
        private ExternalContentUrl $url,
        private ExternalContentUrl $captionsUrl,
    ...
    public static function fromPayload(ContentBlockId $id, int $position, array $payload): self
    {
        ...
        return new self(
            ...
            ExternalContentUrl::fromString($captions),
            $transcript,
    ...
    public function payload(): array
    {
        return array_filter([
            'url' => $this->url->value(),
            'captions_url' => $this->captionsUrl->value(),
